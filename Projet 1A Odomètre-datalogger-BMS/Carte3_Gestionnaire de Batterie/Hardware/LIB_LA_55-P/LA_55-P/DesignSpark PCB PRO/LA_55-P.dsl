...
(library Library_1
	...
	(patternDef "LA55-P" (originalName "LA55-P")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -14.4, 0.2) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "LA_55-P" (originalName "LA_55-P") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "M") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "NEG") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "POS") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-16/DSA-314841.pdf")
	)
